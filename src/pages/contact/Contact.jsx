      ...
      <section className="contact-section">
        ...
        <form ref={form} className="contact-form" onSubmit={onSubmit}>
          <div>
            ...
            <Fade bottom>
              <p>
              I am interested in freelance opportunities and am always available to work on new projects.
               If you have any job offers for me, please feel free to reach out to me using the form below.
               Additionally, if you would like to discuss other topics such as physics and football, I am more than happy to do so over a cup of tea.
              </p>
            </Fade>
          </div>
          <Fade bottom>
          ...
          <Reveal bottom>
            <footer className="footer">
              <p> &copy; copyright All Right Reserved TaniKroos - 2023</p>
            </footer>
          </Reveal>
        </form>
